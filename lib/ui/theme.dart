...
Color wGreenColor = const Color(0xff0EC3AE);
Color wRedColor = const Color(0xffEB70A5);
Color wBackgroundColor = const Color(0xffFAFAFA);
Color wInactiveColor = const Color(0xffDBD7EC);
Color wTransparentColor = Colors.transparent;
...
TextStyle greyTextStyle = GoogleFonts.poppins(color: wGreyColor);
